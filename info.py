...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'HombaleCinemasChat')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "True")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION","IMDB_TEMPLATE","<b>Title 🎬: <code>{file_name}</code>\n</b> <b>{year}</b> <b>Quality 💿: {mimi_type} {width} {height}\n</b> <b>Audio 🔊: #{languages}\n\n</b> <b>Info ☠️: {kind} </b> <b> {seasons}\n</b> <b>JOIN & SUPPORT | @HombaleCinemas\n\n</b> Size : <i>{file_size}</i>")
